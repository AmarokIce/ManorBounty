...
import com.djinfinite.manors_bounty.block.renderer.HoundstoothCarpetDisplayItemRenderer;

import java.util.List;
import java.util.function.Consumer;

public class HoundstoothCarpetDisplayItem extends BlockItem implements GeoItem {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

	public HoundstoothCarpetDisplayItem(Block block, Properties settings) {
	...
	public void initializeClient(@NotNull Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new HoundstoothCarpetDisplayItemRenderer();
