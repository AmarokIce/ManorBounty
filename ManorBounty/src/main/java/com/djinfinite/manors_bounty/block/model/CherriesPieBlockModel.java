...
public class CherriesPieBlockModel extends GeoModel<CherriesPieTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(CherriesPieTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(CherriesPieTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(CherriesPieTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
