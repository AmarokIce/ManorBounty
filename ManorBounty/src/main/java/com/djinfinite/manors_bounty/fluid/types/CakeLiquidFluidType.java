...
public class CakeLiquidFluidType extends FluidType {
	public CakeLiquidFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("manors_bounty:block/cake_liquid_still");
			private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("manors_bounty:block/cake_liquid_flow");
