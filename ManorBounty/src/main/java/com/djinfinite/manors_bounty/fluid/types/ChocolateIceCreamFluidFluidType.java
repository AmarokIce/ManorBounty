...
public class ChocolateIceCreamFluidFluidType extends FluidType {
	public ChocolateIceCreamFluidFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("manors_bounty:block/chocolate_ice_cream_fluid_still");
			private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("manors_bounty:block/chocolate_ice_cream_fluid_flow");
