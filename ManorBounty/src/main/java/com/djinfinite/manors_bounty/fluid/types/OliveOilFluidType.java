...
public class OliveOilFluidType extends FluidType {
	public OliveOilFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("manors_bounty:block/olive_oil_still");
			private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("manors_bounty:block/olive_oil_flow");
