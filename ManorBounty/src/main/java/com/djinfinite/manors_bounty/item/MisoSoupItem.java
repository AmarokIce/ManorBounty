...
import com.djinfinite.manors_bounty.procedures.MisoSoupPlaceProcedure;
...
public class MisoSoupItem extends Item {
	...
	public @NotNull InteractionResult useOn(@NotNull UseOnContext context) {
		super.useOn(context);
		return MisoSoupPlaceProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getClickedFace(), context.getPlayer(), context.getItemInHand());
	}
}
