...
public class LuauPaleteria extends Item implements IFoodItem {
    public LuauPaleteria() {
    ...
    public FoodType getFoodType() {
        return FoodType.LUAU_PALETERIA;
    }

    @Override
    public FoodEffect getFoodEffect() {
        return FoodEffect.C.of()
                .addEffect(ModMobEffects.ORIGINAL_EVOLUTION.get(),95,30,1,480*20)
                .addEffect(ModMobEffects.SUMMER_HEATWAVE.get(),95,30,1,480*20)
                ;
    }
