...
import com.djinfinite.manors_bounty.procedures.CuttingBoardKnifeBottonClickProcedure;
...
public class CuttingBoardGuiButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			CuttingBoardKnifeBottonClickProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 1) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		ManorsBountyMod.addNetworkMessage(CuttingBoardGuiButtonMessage.class, CuttingBoardGuiButtonMessage::buffer, CuttingBoardGuiButtonMessage::new, CuttingBoardGuiButtonMessage::handler);
	}
}
