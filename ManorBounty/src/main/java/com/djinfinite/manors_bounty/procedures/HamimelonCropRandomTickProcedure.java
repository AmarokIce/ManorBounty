...
public class HamimelonCropRandomTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		if (VanillaCropGrowthCheckProcedure.execute(world, x, y, z, blockstate, 7)) {
			if ((blockstate.getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip1 ? blockstate.getValue(_getip1) : -1) <= 4) {
				...
				HamimelonCropMelonSetProcedure.execute(world, x, y, z);
			}
		}
	}
}
