...
public class JalapenoCropRandomTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		...
		if ((new Object() {
			...
			if (VanillaCropGrowthCheckProcedure.execute(world, x, y, z, blockstate, 3) && (blockstate.getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip5 ? blockstate.getValue(_getip5) : -1) < 3) {
