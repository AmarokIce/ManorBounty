...
public class StrawberryFoodEffectUsingProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
		...
		if (DoFruitEffectEnableCheckProcedure.execute()) {
            ...
            if ((entity.getCapability(ManorsBountyModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ManorsBountyModVariables.PlayerVariables())).MB_StrawberryCooldown <= 0) {
                    ...
                    if (do_effect_have && org_effect_level <= 2) {
							...
							_entity.addEffect(new MobEffectInstance(ModMobEffects.BURSTING_BERRY.get(), (int) org_effect_time, (int) (org_effect_level + 1), false, false));
						{
							...
							entity.getCapability(ManorsBountyModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
								capability.MB_StrawberryCooldown = _setval;
				...
				if (itemstack.getItem() == ModItems.PINEBERRY.get()) {
                    ...
                    do_effect_have = entity instanceof LivingEntity _livEnt18 && _livEnt18.hasEffect(ModMobEffects.BURSTING_BERRY.get());
                    org_effect_level = entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(ModMobEffects.BURSTING_BERRY.get()) ? _livEnt.getEffect(ModMobEffects.BURSTING_BERRY.get()).getAmplifier() : 0;
                    org_effect_time = entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(ModMobEffects.BURSTING_BERRY.get()) ? _livEnt.getEffect(ModMobEffects.BURSTING_BERRY.get()).getDuration() : 0;
                    if (do_effect_have && org_effect_level <= 2) {
						if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
                    ...
                    do_effect_have = entity instanceof LivingEntity _livEnt22 && _livEnt22.hasEffect(ModMobEffects.BURSTING_BERRY.get());
                    org_effect_level = entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(ModMobEffects.BURSTING_BERRY.get()) ? _livEnt.getEffect(ModMobEffects.BURSTING_BERRY.get()).getAmplifier() : 0;
                    org_effect_time = entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(ModMobEffects.BURSTING_BERRY.get()) ? _livEnt.getEffect(ModMobEffects.BURSTING_BERRY.get()).getDuration() : 0;
                    if (do_effect_have && org_effect_level <= 2) {
						if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
			...
			if ((entity.getCapability(ManorsBountyModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ManorsBountyModVariables.PlayerVariables())).MB_StrawberryFoodsCooldown <= 0) {
				if (itemstack.getItem() == ModItems.STRAWBERRY_SHAKE.get()) {
					if (Math.random() < 0.7) {
                        do_effect_have = entity instanceof LivingEntity _livEnt28 && _livEnt28.hasEffect(ModMobEffects.BURSTING_BERRY.get());
                        org_effect_level = entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(ModMobEffects.BURSTING_BERRY.get()) ? _livEnt.getEffect(ModMobEffects.BURSTING_BERRY.get()).getAmplifier() : 0;
                        org_effect_time = entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(ModMobEffects.BURSTING_BERRY.get()) ? _livEnt.getEffect(ModMobEffects.BURSTING_BERRY.get()).getDuration() : 0;
                        if (do_effect_have) {
							if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
								_entity.addEffect(new MobEffectInstance(ModMobEffects.BURSTING_BERRY.get(), (int) (org_effect_time + b_type_add_time), (int) org_effect_level, false, false));
							{
                        ...
                        do_effect_have = entity instanceof LivingEntity _livEnt32 && _livEnt32.hasEffect(ModMobEffects.BURSTING_BERRY.get());
                        org_effect_level = entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(ModMobEffects.BURSTING_BERRY.get()) ? _livEnt.getEffect(ModMobEffects.BURSTING_BERRY.get()).getAmplifier() : 0;
                        org_effect_time = entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(ModMobEffects.BURSTING_BERRY.get()) ? _livEnt.getEffect(ModMobEffects.BURSTING_BERRY.get()).getDuration() : 0;
                        if (org_effect_level <= 4) {
							if (do_effect_have) {
								if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
									_entity.addEffect(new MobEffectInstance(ModMobEffects.BURSTING_BERRY.get(), (int) (org_effect_time + b_type_add_time), (int) (org_effect_level + 1), false, false));
							} else {
								if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
									_entity.addEffect(new MobEffectInstance(ModMobEffects.BURSTING_BERRY.get(), (int) b_type_new_time, 0, false, false));
							}
							{
								double _setval = rough_fruit_cd_time;
								entity.getCapability(ManorsBountyModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
				...
				if (itemstack.getItem() == ModItems.STRAWBERRY_DONUT.get()) {
					if (Math.random() < 0.9) {
                        do_effect_have = entity instanceof LivingEntity _livEnt39 && _livEnt39.hasEffect(ModMobEffects.BURSTING_BERRY.get());
                        org_effect_level = entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(ModMobEffects.BURSTING_BERRY.get()) ? _livEnt.getEffect(ModMobEffects.BURSTING_BERRY.get()).getAmplifier() : 0;
                        org_effect_time = entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(ModMobEffects.BURSTING_BERRY.get()) ? _livEnt.getEffect(ModMobEffects.BURSTING_BERRY.get()).getDuration() : 0;
							...
							if (do_effect_have) {
								...
								if (Math.random() < 0.15) {
                                    if (entity instanceof LivingEntity _livEnt43) {
                                        _livEnt43.hasEffect(ModMobEffects.BURSTING_BERRY.get());
                                    }
								...
								if (Math.random() < 0.15) {
                                    if (entity instanceof LivingEntity _livEnt48) {
                                        _livEnt48.hasEffect(ModMobEffects.BURSTING_BERRY.get());
                                    }
                                    org_effect_level = entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(ModMobEffects.BURSTING_BERRY.get())
                                            ? _livEnt.getEffect(ModMobEffects.BURSTING_BERRY.get()).getAmplifier()
                                            : 0;
