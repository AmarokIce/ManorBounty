...
public class WoodMushroomBonemealUseProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		if (blockstate.getBlock() == ModBlocks.WOOD_MUSHROOM.get()) {
			world.setBlock(BlockPos.containing(x, y, z), ModBlocks.WOOD_MUSHROOM_2.get().defaultBlockState(), 3);
		} else if (blockstate.getBlock() == ModBlocks.WOOD_MUSHROOM_2.get()) {
